...
urlpatterns = [
    ...
    # GET: student detail, PUT: update student, DELETE: delete student

    # Course CRUD URLs
    path('courses/', CourseApi.as_view(), name='course-list-create'),  # GET: list courses, POST: create course
    path('courses/<int:pk>/', CourseApi.as_view(), name='course-detail'),
    # GET: course detail, PUT: update course, DELETE: delete course
